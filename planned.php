        ...
        <div class="main-today">
          <div class="header">
            <div class="column column1">
              <div class="item item1">
                <span class="material-icons-outlined menu-icon my-day-icon">calendar_today</span>
                <span class="my-day">បានរៀបចំផែនការ</span>
                <br />
          ...
          <div class="data">
            <ul class="ul">
              <li class="item">
                <input type="radio" class="circle" disabled />
                <span class="title">Sample Planned Task 1</span>
                <span class="delete-btn">Delete</span>
              </li>
              <li class="item">
                <input type="radio" class="circle" disabled />
                <span class="title">Sample Planned Task 2</span>
                <span class="delete-btn">Delete</span>
              </li>
            </ul>
          </div>
